...
var MyLabel = function (_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("span", __assign({ className: "label ".concat(size, " text-").concat(color), style: { color: fontColor } }, { children: [" ", allCaps ? label.toUpperCase() : label, " "] })));
};
